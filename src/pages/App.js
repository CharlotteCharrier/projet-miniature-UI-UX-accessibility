...
function AppContent() {
  ...
  const [postsMap, owners] = useMemo(() => {
    ...
    [...posts.content, ...posts.content.flatMap((post) => post.attachments).filter((attachment) => attachment?.type === "post")].forEach(
      (post) => {
    ...
    <div className="app-container">
      ...
      <div className="posts-container">
        {posts.content?.map((post) => {
          const owner = typeof post.owner === "object" ? post.owner : getOwner(post.owner);
